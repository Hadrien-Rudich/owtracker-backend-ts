...
userRouter
    .route('/:id/details')
    .patch((0, validator_1.validateData)(user_1.UserSchema.update), userController_1.userController.updateUserAccountDetails);
userRouter
    .route('/:id/security')
    .patch((0, validator_1.validateData)(user_1.UserSchema.updatePassword), userController_1.userController.updateUserAccountPassword);
