...
authRouter.route('/logout').post(authController_1.authController.logOut);
authRouter
    .route('/register')
    .post((0, validator_1.validateData)(user_1.UserSchema.register), userController_1.userController.registerUser);
