...
authRouter
    .route('/login')
    .post((0, validator_1.validateData)(user_1.UserSchema.userLogin), authController_1.authController.logIn);
authRouter
    .route('/register')
    .post((0, validator_1.validateData)(user_1.UserSchema.userRegister), userController_1.userController.registerUserAccount);
